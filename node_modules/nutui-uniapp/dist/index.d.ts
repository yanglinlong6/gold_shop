...
declare const avatargroupProps: {
     ...
     */
    maxCount: (NumberConstructor | StringConstructor)[];
    /**
...
type RadioButtonSize = 'large' | 'normal' | 'small' | 'mini';
declare const radioProps: {
     ...
     */
    size: {
        type: vue.PropType<RadioButtonSize>;
        default: RadioButtonSize;
    };
    customClass: {
        type: vue.PropType<ClassType>;
        default: string;
